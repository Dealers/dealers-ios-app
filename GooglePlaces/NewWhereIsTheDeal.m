...
@interface NewWhereIsTheDeal ()

@end

@implementation NewWhereIsTheDeal
...
//    [self.searchTableView deselectRowAtIndexPath:self.storeSearchTableView.indexPathForSelectedRow animated:YES];
